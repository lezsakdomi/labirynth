  ...
  begin
    ...
    begin
      ...
      begin
        ...
        drawPixelMinimap(mmx, mmy, mmi, mmj, clGreen);
        ...
        begin
         ...
         //if Level.isWall[fullPosition.X, fullPosition.Y] then Inc(wallCnt);
          ...
          drawPixelMinimap(mmx, mmy, mmi, mmj, clRed);
          jmax:=cw/Xmax/2;
          if dbg then jmax:=0;
          ...
          begin
            ...
            for j:=-round(jmax) to round(jmax) do
              if (abs(j) mod Level.wallMod)=0 then
      ...
      begin
        drawPixelMinimap(mmx, mmy, mmi, mmj, clWhite);
      end;
    end;
  end;
